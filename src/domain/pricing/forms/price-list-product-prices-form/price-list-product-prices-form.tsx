  ...
  return (
    <div className="h-full">
      ...
      >
        ...
        >
          <thead>
            <tr className="[&_th]:txt-compact-small-plus text-ui-fg-subtle [&_th]:border-ui-border-base h-10 [&_th]:min-w-[220px] [&_th]:border-b [&_th]:border-r [&_th:last-of-type]:border-r-0">
