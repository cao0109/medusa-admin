    ...
    <SideModal isVisible close={close}>
      ...
      >
        <div className="flex h-full flex-col justify-between">
            ...
            <div className="flex h-full flex-col justify-between gap-y-8 px-8 pb-8 pt-6">
              <div className="flex flex-col gap-y-6">
                ...
                <div>
                  ...
                  <div
                    className={`
                  inter-base-regular mt-6 grid 
                  border-collapse
                  grid-cols-2
                  grid-rows-3 border-grey-20 bg-grey-5 text-grey-50 
                  ...
                  >
                    ...
                    <div className="flex justify-end space-x-3 rounded-tr-rounded">
                      <p className="inter-base-regular truncate text-grey-50 ">
                    ...
                    <div className="flex items-center rounded-br-rounded bg-grey-0 text-grey-80">
                      <input
                        ...
                        max={maxReservation}
                      />
                      <span className="nowrap whitespace-nowrap pl-2 text-grey-50">
                        {maxReservation
                          ? t(
                ...
                <div className="inter-base-regular border-t border-grey-20 pt-6">
                  <p className="inter-base-semibold">
                    {t("reservation-description", "Description")}
                  </p>
                  <p className="mb-6 text-grey-50">
                    {t(
                ...
                <div className="border-grey w-full items-center border-t border-grey-20 pt-6">
          ...
          <div className="flex w-full justify-end gap-x-xsmall border-t px-8 pt-4 pb-6">
            <Button
              variant="ghost"
              size="small"
              className="border"
