...
function SalesChannelsList(props: SalesChannelsListProps) {
  ...
  return (
    <div className="col-span-1 grow  rounded-lg border border-grey-20 bg-grey-0 px-8 py-6">
      <SalesChannelsHeader
...
function SalesChannelDetails(props: SalesChannelDetailsProps) {
  ...
  return (
    <div className="col-span-2 col-span-2 h-fit rounded-rounded border border-grey-20 bg-grey-0 px-8 py-6">
...
function Details() {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 gap-x-xsmall">
        <SalesChannelsList
          filterText={filterText}
          setFilterText={setFilterText}
          openCreateModal={openCreateModal}
