...
const ReservationForm: React.FC<Props> = ({ form }) => {
  ...
  return (
    <div className="flex w-full flex-col gap-6">
      ...
      <div className="grid w-full grid-cols-2 items-center">
        ...
        {selectedItem && locationLevel && (
          <div className="col-span-2 flex w-full flex-col">
            <div
              className={`
            mt-8 grid border-collapse 
            grid-cols-2
            grid-rows-5 border-grey-20 bg-grey-5 text-grey-50 
      ...
      <div className="border-grey grid w-full grid-cols-2 items-center border-t border-grey-20 py-6">
        <div>
          <p className="inter-base-semibold mb-1">
