    ...
    >
      <DropdownMenu.Root>
        ...
        <DropdownMenu.Content
          align="start"
          sideOffset={10}
          className="z-30 max-h-[500px] min-w-[272px] overflow-y-scroll rounded-rounded border border-grey-20 bg-grey-0 shadow-dropdown"
        >
          <DropdownMenu.Label className="px-[12px] py-2 text-small font-medium text-gray-400">
            Currencies
          </DropdownMenu.Label>
          {currencies?.map((c) => (
            <DropdownMenu.Item
          ...
          <DropdownMenu.Label className="border-t border-gray-200 px-[12px] py-2 text-small font-medium text-gray-400">
            Regions
          </DropdownMenu.Label>
          {regions?.map((r) => (
            <DropdownMenu.Item
