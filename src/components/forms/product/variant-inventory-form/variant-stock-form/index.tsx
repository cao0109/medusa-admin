  ...
  return (
    <Accordion type="multiple" defaultValue={["general"]}>
      <Accordion.Item title="General" value="general">
        <div className="mt-large flex flex-col gap-y-xlarge">
      ...
      <Accordion.Item title="Inventory" value="inventory">
        <div className="mt-large flex flex-col gap-y-small">
      ...
      <form onSubmit={handleSubmit}>
        <Modal.Content>
          <div>
            <div
              className={clsx(
                "flex w-full items-center justify-between border-grey-20 text-grey-50",
                { "border-b pb-base": locationsAvailable }
              )}
            >
              <div>
                <p>
