...
const SettingsPageErrorElement = ({
  ...
  return (
    <div className="flex h-full w-full items-center justify-center">
      <div className="flex justify-start gap-x-small rounded-rounded border border-rose-40 bg-rose-10 p-base">
        <div>
          <WarningCircleIcon
            size={20}
            fillType="solid"
        ...
        <div className="inter-small-regular w-full pr-[20px] text-rose-40">
